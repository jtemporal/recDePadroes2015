...
Neste aquivo vocÃª encontra um guideline para fazer o download de seus dados de interesse
assim como fazer uns negÃ³cios da hora com eles...

Use com moderacao e divirta-se
...
pedindo permissÃo para fazer o download, eh soh aceitar)
```{r}
downloadMatrix(link)
```
- Lendo os dados:
...
```
Aqui vocÃª pode definir manualmente as cores para os tipos de paciente ou
deixar que a funÃ§Ã£o doColourPalette faÃ§a isso para vocÃª automaticamente
(olhe a documentaÃ§Ã£o dessa funÃ§Ã£o para maiores detalhes como a quais colunas df
deve conter).
...
```
Por questÃµes que vamos explicar mais tarde, vamos separar uma amostra de cada
tipo e "tirar" elas da nossa matriz principal. Num estudo real vocÃª nÃ£o vai
